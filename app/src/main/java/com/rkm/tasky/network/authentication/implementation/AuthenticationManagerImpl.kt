...
class AuthenticationManagerImpl @Inject constructor(
    ...
    override suspend fun logOut(): EmptyResult<NetworkError.AuthError> = withContext(dispatcher) {
    ...
    override suspend fun checkAuthentication(): EmptyResult<NetworkError.AuthError> =
        withContext(dispatcher) {
            return@withContext repository.checkAuthentication().asEmptyDataResult()
        }

    override suspend fun getNewAccessToken(): EmptyResult<NetworkError.AuthError> =
        withContext(dispatcher) {
